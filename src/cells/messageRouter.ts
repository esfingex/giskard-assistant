...
export interface ChatRouterDeps {
    ...
    handlePrompt(prompt: string, model?: string, includeActiveFile?: boolean, contextType?: string, tabId?: string): Promise<void>;
    ...
    webview.onDidReceiveMessage(async (data) => {
        try {
            ...
            case 'sendPrompt': {
                ...
                await deps.handlePrompt(data.prompt, data.model, data.includeActiveFile, data.contextType, data.tabId);
                break;
            }
            case 'stopGeneration':
                deps.abortActive();
            ...
            case 'loadMcpServers':
                ...
                break;
            case 'addMcpServer':
                await handleAddMcpServer(deps.getView(), deps.store, data.name, data.serverType, data.commandOrUrl);
                break;
